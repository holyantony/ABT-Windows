...
public class Report {
	...
	public void copyPDF(String filename,Object client_id) {

		try {

			conn.getClient().call("copyPDF",filename);
	...
	public void copyCSV(String filename,Object client_id) {

		try {

			conn.getClient().call("copyCSV",filename);
	...
	public void copyexport(Object client_id) {

		try {
			conn.getClient().call("copyexport");
	...
	public void pushexport(Object client_id) {

		try {
			conn.getClient().call("pushexport");
	...
	public void copyDocs() {
		...
		try {
			System.out.println("In copy docs");
			conn.getClient().call("copyDocs");
